...
public abstract class AbstractID3v2Tag extends AbstractID3Tag implements Tag
{
    ...
    */
    ...
    private void replaceFile(File originalFile, File newFile) throws IOException
    {
        ...
        File originalFileBackup = new File(originalFile.getAbsoluteFile().getParentFile(), AudioFile.getBaseFilename(originalFile) + ".old");
        //If already exists modify the suffix
        int count = 1;
        while (originalFileBackup.exists())
        {
        	
            originalFileBackup = new File(originalFile.getAbsoluteFile().getParentFile(), AudioFile.getBaseFilename(originalFile) + ".old" + count);
